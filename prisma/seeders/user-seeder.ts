...
export async function userSeeder() {
  ...
  const userData = [
    ...
    { id: 'ertetrcm71x2fhs89hd00asgp', name: 'Greg Depthead', email: 'dh@example.com', password: hashedPassword, role: 'role-dh', phone: '1234567898', workDivision: 'OPS', employeeId: 'EMP010', residentId: 'RES010', nationality: 'ID', birthday: new Date('1977-09-19') },
    { id: '35u8t9wrhidvbs487w3g8iwr9', name: 'Another Depthead', email: 'dh2@example.com', password: hashedPassword, role: 'role-dh', phone: '1234567898', workDivision: 'HRD', employeeId: 'EMP011', residentId: 'RES011', nationality: 'ID', birthday: new Date('1989-11-23') },
  ];

    ...
    const fetchData = async () => {
      try {
        ...
        if (response.ok) {
          ...
          console.log('data.purchaseRequest : ', data.purchaseRequest);
          ...
          setFormData({
            ...
            steps: data.purchaseRequest.approvalSteps.map((step: ApprovalStepForm) => ({
              ...
              specificUser: {
                id: step.specificUser.id,
                name: step.specificUser.name
              }
            }))
          });
        }
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex flex-col gap-2">
              <div className="text-sm text-gray-500">
                PR Code: <span className="font-semibold text-gray-900">{formData.code}</span>
              </div>
              <div className="text-sm text-gray-500">
